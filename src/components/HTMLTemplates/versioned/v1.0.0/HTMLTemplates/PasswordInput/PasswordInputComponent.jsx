  ...
  return `
      ...
      <label class="tds-label" for="${forAttribute}">Password</label>
       ...
       <div class="tds-input__wrapper  ${error ? `tds-input--error` : ''} tds-password-input__wrapper">
        <input class="tds-input-password ${error ? 'tds-input-password--error' : ''} tds-password-input__input" type="${isOpened ? 'password' : 'text'}" id="${forAttribute}" name="${forAttribute}" spellcheck="false" autocomplete="current-password" ${valueAttribute} autocapitalize="none" />
