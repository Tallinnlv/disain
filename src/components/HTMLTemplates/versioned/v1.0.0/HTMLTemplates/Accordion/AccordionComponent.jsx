 ...
 */
export function AccordionComponent({ sections, showSuffix = false }) {
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M5.69189 11.5764L7.64137 9.7569L16 18.7125L24.3586 9.7569L26.308 11.5764L16 22.6208L5.69189 11.5764Z" fill="#131416"/>
                  ...
                  <span
                    class="tds-accordion__section-heading-text"
                    id="${headingId}"
                  >
                    <span class="tds-accordion__section-heading-text-focus">
                      ${section.heading}
                    </span>
                  </span>
            ...
            <div
              id="${contentId}"
              class="tds-accordion__section-content"
              ${section.expanded ? `` : `hidden="until-found"`}
            >
