...
>
  <div class="tds-dialog tds-dialog--${size}${scrollClass}">
    <div class="tds-dialog__header">
      ...
      ${closeButton ? `<button class="tds-button--icon-neutral tds-button--icon--compact tds-notification-close" aria-label="Sulge" type="button">
    ...
    <div class="tds-dialog__footer">
      ${secondaryButton ? `<button class="tds-button tds-button--secondary-neutral" aria-label="${secondaryLabel}" data-modal-close type="button">
        ${secondaryLabel}
      </button>` : ''}
      ${dangerButton ? `<button class="tds-button tds-button--danger" aria-label="${primaryLabel}" data-modal-accept type="button">
        ${primaryLabel}
      </button>`
        : `<button class="tds-button tds-button--primary" aria-label="${primaryLabel}" data-modal-accept type="button">
        ${primaryLabel}
      </button>`}
    </div>
  </div>
