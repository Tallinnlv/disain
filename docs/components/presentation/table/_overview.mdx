    ...
    data: [
      {
        period: '23.08.2024',
        nr: '18043',
        pealkiri: `<a href="javascript:void(0);" class="tds-link tds-link--inline">
...
displayBlock
  ...
  code={TableComponent({
    ...
    data: [
      {
        avatar: `<div class="avatar-icon avatar-icon--text-black" style="background-color: #F5C940;" data-demo-style="">AV</div>`,
        text: '03.06.2024',
        ...
        badge: `<span class="tds-badge tds-badge--primary tds-badge--small" role="status" aria-label="22 new notifications">
          <span class="tds-badge__text tds-badge__text--small tds-badge__text--bold">22</span>
        </span>`,
        button: `<a href="javascript:void(0);" class="tds-link tds-link--compact tds-link--inline tds-link--icon-left">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M10 3C8.89543 3 8 3.89543 8 5V6H4V8H5.03774L5.42678 18.1153C5.48873 19.7261 6.81256 21 8.42456 21H15.5754C17.1874 21 18.5113 19.7261 18.5732 18.1153L18.9623 8H20V6H16V5C16 3.89543 15.1046 3 14 3H10ZM14 6V5H10V6H14ZM7.4253 18.0384L7.03922 8H16.9608L16.5747 18.0384C16.5541 18.5754 16.1128 19 15.5754 19H8.42456C7.88723 19 7.44595 18.5754 7.4253 18.0384ZM9 17V9.99997H11V17H9ZM13 10L13 17H15L15 10H13Z" fill="currentColor"/>
    ...
    `,
      ...
      {
        avatar: `<div class="avatar-icon" style="background-color: #0060AD;" data-demo-style="">AV</div>`,
        text: '03.06.2024',
        link: `<a href="javascript:void(0);" class="tds-link tds-link--inline ">Tallinna linnaosade ja linnaosade valitsuste põhimäärused</a>`,
        badge: `<span class="tds-badge tds-badge--green tds-badge--small" role="status" aria-label="44 new notifications">
    <span class="tds-badge__text tds-badge__text--small tds-badge__text--bold">44</span>
  </span>`,
        button: `<a href="javascript:void(0);" class="tds-link tds-link--compact tds-link--inline tds-link--icon-left">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M13 14.5858V2H11V14.5858L5.70712 9.29289L4.29291 10.7071L12 18.4142L19.7071 10.7071L18.2929 9.29289L13 14.5858ZM4 22H20V20H4V22Z" fill="#0060AD" />
    ...
    data: [
      {
        liik: 'Akt viitab',
        loodud: '03.06.2024',
        pealkiri: `<a href="javascript:void(0);" class="tds-link tds-link--inline">Linnaosa valitsuse väljastatavate müügilubade hindade kehtestamine</a>`,
        nr: '382',
        voetud: '26.04.2023',
      },
      {
        liik: 'Akt viitab',
        loodud: '03.06.2024',
        pealkiri: `<a href="javascript:void(0);" class="tds-link tds-link--inline">Tallinna linnaosade ja linnaosade valitsuste põhimäärused</a>`,
        nr: '8',
        voetud: '20.04.2017',
      },
    ],
