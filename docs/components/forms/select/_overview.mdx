...
<CodePreview
  ...
  code={SelectComponent({
    title: 'Linnaosa',
    searchable: true,
    selectCustomText: 'Vali linnaosa',
    searchPlaceholder: 'Otsi linnaosa',
    clearSearchLabel: 'Tühjenda otsing',
    noResultsText: 'Tulemusi ei leitud',
    resultText: '1 tulemus',
    resultsText: '{count} tulemust',
    selectOptions: [
      { value: 'haabersti', label: 'Haabersti' },
      { value: 'kesklinn', label: 'Kesklinn' },
      { value: 'kristiine', label: 'Kristiine' },
      { value: 'lasnamae', label: 'Lasnamäe' },
      { value: 'mustamae', label: 'Mustamäe' },
      { value: 'nomme', label: 'Nõmme' },
      { value: 'pirita', label: 'Pirita' },
      { value: 'pohja-tallinn', label: 'Põhja-Tallinn' },
    ],
  })}
/>
