...
<div>
  ...
  <p>
    In case there is some non-editable data relevant to the form (for example,
    persons name and address imported from the population register), it should
    be presented as plain text and preferrably at the beginning of the form.
  </p>
  <span style={{ display: 'flex', gap: '16px' }}>
    <span className="circle">
