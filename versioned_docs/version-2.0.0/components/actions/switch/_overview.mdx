  ...
  code={`
    <div class="example-section">
      ...
      ${SwitchComponent({
        ...
        checked: true,
        withDivider: true,
        controls: 'notification-options',
      })}
      </div>
      <div class="tds-switch-nested" id="notification-options">
        ${SwitchComponent({
          label: 'Push notifications',
          align: 'right',
          isNested: true,
  ...
  code={`
    ...
    <div class="example-section__master">
      ${SwitchComponent({
        ...
        checked: false,
        withDivider: true,
        controls: 'notification-options-disabled',
      })}
      </div>
      <div class="tds-switch-nested" id="notification-options-disabled">
        ${SwitchComponent({
          label: 'Push notifications',
          align: 'right',
          isNested: true,
