    ...
    sections: [
      {
        ...
        content: 'Content 1',
        suffix: () => `<span
    class="tds-badge tds-badge--primary tds-badge--small tds-badge--align-left"
  ...
  >
    <span class="tds-badge__text tds-badge__text--small tds-badge__text--bold">22</span>
      ...
      },
      {
        ...
        suffix: () =>
          `<span
    class="tds-badge tds-badge--green tds-badge--medium tds-badge--align-left"
    role="status" aria-label="UUS!"
  >
